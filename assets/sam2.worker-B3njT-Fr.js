      ...
      if (ur = true, Rt()) return new Promise((t, e) => {
        He == null ? void 0 : He.terminate(), _s().then(([r, n]) => {
          try {
            ...
            !o.in.wasm.wasmPaths && (r || Xn) && (o.in.wasm.wasmPaths = { wasm: new URL("" + new URL("ort-wasm-simd-threaded.jsep-6MnTkKum.wasm", import.meta.url).href, import.meta.url).href }), He.postMessage(o), fn = r;
          } catch (o) {
            e(o);
          }
        }, e);
