...
var ys, Xn, Tf, Le, bs, Yn, If, Cf, ws, Af, hs, _s, gs, vs, Cr = V(() => {
  Ir();
...
var Jn, eo, Mr, $s, Ef, kf, Pf, Ar, ge, vt = V(() => {
  Cr();
...
var $t, rt, xt, Lt, tr, Nr, Vr, to, J = V(() => {
  $t = (t) => {
    switch (t) {
      case "int8":
        return 3;
...
var Os, ao, zs, Nf, Ps, Vf, Ds, Hr, Fr, io, Bs, Ms = V(() => {
  J();
  nt();
...
var Us, so, uo, Wf, Gf, Ns, co, lo, Ls, Ws = V(() => {
  nt();
  jr();
...
var Dt, fo, be, Pe, L, fe, ho, Bt, je, F, Zr, O, R, Gs, Qr, mo, Hs, ae = V(() => {
  J();
  ne();
  Dt = 64, fo = (t, e) => {
...
var Hf, Fs, Ff, qf, Kf, jf, Oe, qs, Ks, pt = V(() => {
  J();
  ne();
  Ie();
  ae();
...
var Zf, Qf, Yf, Xf, Jf, eh, th, rh, nh, oh, it, js, Zs, Qs, Ys, Xs, Js, eu, tu, ru, nu, ou = V(() => {
  J();
  ne();
  ae();
  Yr();
...
var at, ih, Xr, go, st, ah, sh, uh, dh, lh, ch, ph, mh, fh, hh, ut, iu, au, su, uu, du, lu, cu, pu, mu, fu, Yr = V(() => {
  J();
  ne();
  Ie();
  ae();
...
var gh, bo, yh, bh, wh, Wt, _h, wu, Jr = V(() => {
  J();
  ne();
  jr();
  ae();
...
var Ih, he, Su, Tu, Iu, Cu, Au, Eu, ku, Pu, Ou, Ch, zu, Du, Bu, Mu, nr, Ru, en, Uu, Nu, Vu, Lu, Wu, Gu, Hu, Fu, qu, Ku, ju, Zu, Qu, Yu, Xu, Ju, ed, td, wo, _o, rd, nd, od, Ah, Eh, id, tn = V(() => {
  J();
  ne();
  Ie();
  ae();
...
var Oh, zh, dt, dd, ld, cd, pd, md, fd, hd, gd, yd, bd, wd = V(() => {
  J();
  ne();
  ae();
...
var Nh, Vh, vo, Id, Lh, $o, Wh, ir, sn = V(() => {
  J();
  ne();
  ae();
  St();
...
var Hh, Ed, un, Fh, kd, qh, Pd, Od, zd = V(() => {
  J();
  nt();
  ne();
  ae();
  ...
  Hh = (t) => {
    ...
    let x = ($) => {
      ...
      Ye(e, T);
      let I = 1, E = be(t[0].dataType), A = O("x", t[0].dataType, t[0].dims.length, g), z = O("W", t[1].dataType, t[1].dims.length, I), v = [A, z], M = R("result", t[0].dataType, r.length, I), N = "";
      if (S) {
...
var Kh, xo, jh, So, To, Rd, Zh, Qh, Io, Ud = V(() => {
  ne();
  Ad();
  zd();
  sn();
...
var Yh, Xh, Jh, Ld, Wd, eg, Gd, tg, Hd, Fd = V(() => {
  Vd();
  St();
  pt();
...
var Co, dn, Xd, ag, sg, Ao, Eo, Jd, ug, el, tl, rl = V(() => {
  J();
  ne();
  Ie();
  ae();
...
var mt, Tt, Gt, Ht, $g, xg, Sg, Tg, Ig, Cg, Ag, Eg, xl, Sl, Tl = V(() => {
  J();
  ne();
  Ie();
  ae();
...
var Qg, Yg, Xg, Jg, ey, ty, ry, ny, Fl, ql = V(() => {
  J();
  ne();
  ae();
  Qg = (t) => {
...
var cn, Kl, jl, Zl, Ql, oy, iy, Yl, Xl, Jl, ec, tc, rc, nc, oc, ic, ac, sc, uc, dc = V(() => {
  Ve();
  J();
  ne();
  ae();
...
var my, fy, hy, bc, gy, yy, by, wy, _y, vy, $y, xy, wc, Sy, Ty, Iy, Cy, Ay, _c, vc, $c = V(() => {
  J();
  ne();
  Ie();
  ae();
...
var Py, pn, Oy, Tc, zy, Dy, Ic, Cc, Ac = V(() => {
  J();
  ne();
  Ie();
  ae();
...
var Fy, Er, kr, Mt, qy, Hc, Jt, Pr, Or, Fc, zr, Dr, Br, Qn = V(() => {
  Ve();
  Ss();
  Is();
  J();
...
var Rt, He, ur, hn, gn, fn, Ro, Uo, Ft, qt, jy, qc, Kc, jc, Zc, Qc, Yc, Xc, No = V(() => {
  Ve();
  Qn();
  vt();
  Cr();
      ...
      if (ur = true, Rt()) return new Promise((t, e) => {
        He == null ? void 0 : He.terminate(), _s().then(([r, n]) => {
          try {
            ...
            !o.in.wasm.wasmPaths && (r || Xn) && (o.in.wasm.wasmPaths = { wasm: new URL("/minerva-annotation-demo/assets/ort-wasm-simd-threaded.jsep-6MnTkKum.wasm", import.meta.url).href }), He.postMessage(o), fn = r;
          } catch (o) {
            e(o);
          }
        }, e);
...
class SAM2 {
  ...
  async load(ort2, signal) {
    ...
    try {
      this.encoderSession = await ort2.InferenceSession.create(encoderBuffer, {
    ...
    try {
      this.decoderSession = await ort2.InferenceSession.create(decoderBuffer, {
        executionProviders: providers,
        graphOptimizationLevel: "all"
      });
  ...
  async encode(ort2, float32Array, shape, signal) {
  ...
  async decode(ort2, points, maskArray, signal) {
    ...
    const feeds = {
      ...
      point_coords: new ort2.Tensor("float32", pointCoords, [1, n, 2]),
      point_labels: new ort2.Tensor("float32", pointLabels, [1, n]),
      mask_input: new ort2.Tensor("float32", maskInputArray, [1, 1, 256, 256]),
      has_mask_input: new ort2.Tensor("float32", new Float32Array([maskArray ? 1 : 0]), [1])
    };
    const results = await this.decoderSession.run(feeds);
    const masks = results.masks;
    const iou = results.iou_predictions;
    return {
      masks: { dims: masks.dims, cpuData: masks.data },
      iou_predictions: iou.data
    };
  }
}
